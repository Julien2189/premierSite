async function getBTCPrice() {
  ...
  getBTCPrice();
  setInterval(getBTCPrice, 1000); // toutes les 5 secondes
  ...
  getXRPPrice();
  setInterval(getXRPPrice, 1000); // toutes les 5 secondes
  ...
  getETHPrice();
  setInterval(getETHPrice, 1000); // toutes les 5 secondes